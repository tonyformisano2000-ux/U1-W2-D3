...
for (i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    ...
    changedSubjects = changedSubjects + ", " + starWarsCharacters[i].name;
  }
}
console.log(changedSubjects, "si identificano cone Robot.");
/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli elementi presenti nell'array "femaleCharacters" rimuovi dall'array "charactersNames" le stringhe corrispondenti a personaggi con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length di "charactersNames" prima e dopo l'operazione.
*/
console.log(
  "L'array characterNames ha una length di ",
...
console.log("e ne possiede ", charactersNames.length, " se vengono esclusi");
/* --EXTRA-- ESERCIZIO 10
